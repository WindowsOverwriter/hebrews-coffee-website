...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/check-order" | "/login" | "/place-order" | "/place-order/[drink]";
		RouteParams(): {
		...
		Pathname(): "/" | "/check-order" | "/check-order/" | "/login" | "/login/" | "/place-order" | "/place-order/" | `/place-order/${string}` & {} | `/place-order/${string}/` & {};
