...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/check-order" | "/login" | "/place-order" | "/place-order/[drink]" | "/place-order/[drink]/confirm";
		RouteParams(): {
